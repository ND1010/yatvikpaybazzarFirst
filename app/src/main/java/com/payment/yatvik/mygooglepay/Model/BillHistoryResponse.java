...
public class BillHistoryResponse {
    ...
    @Expose
    private ArrayList<BillHistory> billHistory =new ArrayList();
    ...
    public ArrayList<BillHistory> getBillHistory() {
        return billHistory;
    }

    public void setBillHistory(ArrayList<BillHistory> billHistory) {
