...
public class BillsHistoyAdapter extends RecyclerView.Adapter<BillsHistoyAdapter.AstroVH> implements Filterable {
    ...
    public BillsHistoyAdapter(List<BillHistoryResponse.BillHistory> astrologerModelList) {
    ...
    public AstroVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_bill_history,parent,false);
    ...
    public void onBindViewHolder(@NonNull final AstroVH holder, int position) {
        final BillHistoryResponse.BillHistory astrologerModel = astrologerModelList.get(position);

        holder.transId.setText(astrologerModel.getTransactionId());
        holder.status.setText(astrologerModel.getStatusC());
        holder.date.setText(astrologerModel.getUpdatedAt());
        holder.service.setText(astrologerModel.getService());
        holder.operator.setText(astrologerModel.getOperator());
        holder.amount.setText(astrologerModel.getAmount());
        holder.mobile.setText(astrologerModel.getMobile());
        holder.message.setText(astrologerModel.getErrorCode());
        holder.ivLblMobile.setVisibility(View.GONE);
        holder.mobile.setVisibility(View.GONE);


        if(astrologerModel.getStatusC().equals("SUCCESS")){
        ...
        holder.btn_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getCheckStatus(astrologerModel.getTransactionId());
            }
        });
    ...
    public class AstroVH extends RecyclerView.ViewHolder {
        ...
        TextView transId,status,date,service,operator,amount,mobile,message,ivLblMobile;
        Button btn_check;
        ...
        public AstroVH(final View itemView) {
            ...
            ivLblMobile = itemView.findViewById(R.id.ivLblMobile);
