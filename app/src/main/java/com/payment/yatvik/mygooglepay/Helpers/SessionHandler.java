...
public class SessionHandler {
     ...
     * @param fullName
     */
    public void loginUser(String id, String username, String fullName, String password, String loginId, String pic) {
        mEditor.putString(KEY_ID, id);
        mEditor.putString(KEY_USERNAME, username);
        mEditor.putString(KEY_FULL_NAME, fullName);
        mEditor.putString(KEY_PASSWORD, password);
        mEditor.putString(KEY_LOGINID, loginId);
    ...
    public User getUserDetails() {
        ...
        user.setLoginId(mPreferences.getString(KEY_LOGINID, KEY_EMPTY));
